...
export const CanvasClassificationComponent = () => {
  ...
  const { data: canvasClassification, refetch, isLoading, error } = useGetTeamReportClassificationByFormatQuery({ idFormatoAvaliacao: EvaluationType.CANVAS, ano: selectedYear })
