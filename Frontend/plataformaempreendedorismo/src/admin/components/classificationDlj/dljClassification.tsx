...
export const DljClassificationComponent = () => {
  ...
  const { data: dljClassification, refetch, isLoading, error } = useGetTeamReportClassificationByFormatQuery({ idFormatoAvaliacao: EvaluationType.DLJ, ano: selectedYear })
